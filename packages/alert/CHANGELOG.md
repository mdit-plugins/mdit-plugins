...
- chore(alert): fix package.json ([194fb13](https://github.com/mdit-plugins/mdit-plugins/commit/194fb13))
...
- fix(alert): correct alert detecting ([9946286](https://github.com/mdit-plugins/mdit-plugins/commit/9946286))
...
- fix(alert): remove debug logging ([572001e](https://github.com/mdit-plugins/mdit-plugins/commit/572001e))

## 0.7.1 (2023-11-25)

- chore(release): publish v0.7.1 ([fa200f0](https://github.com/mdit-plugins/mdit-plugins/commit/fa200f0))
- fix(alert): fix alert deep detect ([1839b87](https://github.com/mdit-plugins/mdit-plugins/commit/1839b87))

## 0.7.0 (2023-11-24)

- chore(release): publish v0.7.0 ([8055b0f](https://github.com/mdit-plugins/mdit-plugins/commit/8055b0f))
- feat: add alert plugin (#34) ([d7c9c01](https://github.com/mdit-plugins/mdit-plugins/commit/d7c9c01)), closes [#34](https://github.com/mdit-plugins/mdit-plugins/issues/34)
