...
- style: fix linter ([2a246db](https://github.com/mdit-plugins/mdit-plugins/commit/2a246db))
...
- docs: update docs ([c6b9247](https://github.com/mdit-plugins/mdit-plugins/commit/c6b9247))

## 0.2.2 (2022-12-29)

- chore(release): publish v0.2.2 ([c584263](https://github.com/mdit-plugins/mdit-plugins/commit/c584263))
- fix(tab): fix multiple instance issue ([907130b](https://github.com/mdit-plugins/mdit-plugins/commit/907130b))

## 0.2.1 (2022-12-29)

- chore(release): publish v0.2.1 ([f1f6dd2](https://github.com/mdit-plugins/mdit-plugins/commit/f1f6dd2))
- feat(tab): add index information ([356c5a5](https://github.com/mdit-plugins/mdit-plugins/commit/356c5a5))

## 0.2.0 (2022-12-29)

- chore(release): publish v0.2.0 ([59c7786](https://github.com/mdit-plugins/mdit-plugins/commit/59c7786))
- feat: add tab plugin ([96d116a](https://github.com/mdit-plugins/mdit-plugins/commit/96d116a))
