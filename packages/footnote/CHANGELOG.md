...
- chore: avoid referencing files inside markdown-it ([997b548](https://github.com/mdit-plugins/mdit-plugins/commit/997b548))
...
- chore: tweaks ([58a7f6c](https://github.com/mdit-plugins/mdit-plugins/commit/58a7f6c))
...
- test: fix snap ([956948b](https://github.com/mdit-plugins/mdit-plugins/commit/956948b))
- test(footnote): add test for xhtml output ([797c436](https://github.com/mdit-plugins/mdit-plugins/commit/797c436))
...
- chore: tweaks ([282a413](https://github.com/mdit-plugins/mdit-plugins/commit/282a413))
- chore: tweaks ([db15b0d](https://github.com/mdit-plugins/mdit-plugins/commit/db15b0d))
