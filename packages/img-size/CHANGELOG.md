...
- feat: add obsidianImageSize plugin ([d20c16d](https://github.com/mdit-plugins/mdit-plugins/commit/d20c16d))

## 0.2.3 (2023-01-01)

- chore(release): publish v0.2.3 ([578c378](https://github.com/mdit-plugins/mdit-plugins/commit/578c378))
- test(img-size): should not break img label ([ab9ceda](https://github.com/mdit-plugins/mdit-plugins/commit/ab9ceda))
